          ...
          <li>
            <div className="comment-item">
              <div className="image-wrap">
                <Image
                  alt=""
                  src="/images/banner/avatar-1.webp"
                  width={120}
                  height={120}
                />
              </div>
              <div className="content">
                ...
                <div className="comment">
                  ...
                  <div className="group-image">
                    <Image
                      alt=""
                      src="/images/banner/comment-1.webp"
                      width={282}
                      height={158}
                    />
                    <Image
                      alt=""
                      src="/images/banner/comment-2.webp"
                      width={282}
                      height={158}
                    />
                    <Image
                      alt=""
                      src="/images/banner/comment-3.webp"
                      width={282}
                      height={158}
                    />
                  </div>
          ...
          <li>
            <div className="comment-item">
              <div className="image-wrap">
                <Image
                  alt=""
                  src="/images/banner/avatar-2.webp"
                  width={120}
                  height={120}
                />
              </div>
          ...
          <li>
            <div className="comment-item">
              <div className="image-wrap">
                <Image
                  alt=""
                  src="/images/banner/avatar-3.webp"
                  width={120}
                  height={120}
                />
              </div>
